...
5. This has been created with RStudio, using [Highchart](https://www.highcharts.com/) and [KableExtra](https://cran.r-project.org/web/packages/kableExtra/vignettes/awesome_table_in_html.html). Highcharts is free for personal use.
...
7. R  Notebook file available [here](hhttps://github.com/carlosyanez/carlosyanez.github.io/blob/master/Chiles_Inequality.Rmd)
