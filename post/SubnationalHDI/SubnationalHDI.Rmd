...
webshot::webshot(str_c(io_repo,'national_hdi.html'), file =  here("static","images",'national_hdi.png'),
        cliprect = "viewport")
}
map1
rm(map1,data)
...
webshot::webshot(str_c(io_repo,'subnational_hdi.html'), file = here("static","images",'subnational_hdi.png'),
        cliprect = "viewport")
}
#map1
rm(map1,data)
